import { buildShiftReportWhatsAppUrl } from "../../utils/shiftWhatsAppReport";
...
/**
 * Admin: öffnet WhatsApp mit vorgefülltem Schichtenreport (Datum, Zeit, Kunde, Aufgaben).
 */
export default function ShiftWhatsAppReportButton({
  schedule,
  variant = "full",
}: ShiftWhatsAppReportButtonProps) {
  const url = buildShiftReportWhatsAppUrl(schedule);
  if (!url) {
    return (
