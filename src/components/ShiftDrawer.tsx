...
export default function ShiftDrawer({
  ...
  useEffect(() => {
    ...
    if (employeeDropdownOpen) document.addEventListener('mousedown', handleClickOutside);
          ...
          {isFormMode ? (
            <form onSubmit={handleSubmit} className="drawer-form">
              ...
              <div className="form-group" ref={employeeDropdownRef}>
                <label htmlFor="drawer-employees">
                  Mitarbeiter{" "}
                  <span className="employee-chip-hint">(Mehrfachauswahl)</span>
                </label>
                <button
                  type="button"
                  id="drawer-employees"
                ...
                >
                  {selectedEmployeeIds.length === 0
                    ...
                    : selectedEmployeeIds.length === 1
                      ? profiles.find((p) => p.id === selectedEmployeeIds[0])?.full_name ?? '1 ausgewählt'
                      : `${selectedEmployeeIds.length} Mitarbeiter ausgewählt`}
                  <svg className="employee-multiselect-chevron" width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M3 5l4 4 4-4" />
                  </svg>
                </button>
              ...
              <div className="drawer-sticky-footer">
                ...
                <div className="drawer-sticky-footer__right">
